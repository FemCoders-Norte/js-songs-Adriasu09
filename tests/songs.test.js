...
describe('function "orderByYear"', () => {
  ...
  it("should return the new array in ascending order", () => {
    expect(
      orderByYear([{ year: 2000 }, { year: 1975 }, { year: 1984 }]),
    ).toEqual([{ year: 1975 }, { year: 1984 }, { year: 2000 }]);
  });
...
describe('function "getShortestSong"', () => {
  ...
  it("should return an array of objects that share the same duration", () => {
    const arr = [
      { title: "Lust For Life", duration: "2min 35sec" },
      { title: "Here Comes Your Man", duration: "2min 35sec" },
      { title: "Enjoy", duration: "5min 12sec" },
    ];
    expect(getShortestSong(arr)).toEqual([
      { title: "Lust For Life", duration: 155 },
      { title: "Here Comes Your Man", duration: 155 },
    ]);
  });
});
